...
public class Person implements Serializable {
    ...
    public Person(String name, String occupation, AgeCategory ageCategory,
                  EmploymentCategory employmentCategory, String taxId, boolean usCitizen, Gender gender) {
        this.name = name;
    ...
    public Person(int id, String name, String occupation, AgeCategory ageCategory,
        ...
        this(name, occupation, ageCategory, empCat, taxId, usCitizen, gender);//call the other constructor

        this.id=id;// set the new id
    }
    public int getId() {
        return id;
    }
