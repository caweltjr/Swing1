...
public class MessageServer implements Iterable<Message> {
    ...
    public MessageServer() {
        ...
        list = new ArrayList<Message>();
        list.add(new Message("What's the roof color?", "Have you decided?"));
        list.add(new Message("Oppression", "Have you seen how much Talaib has been oppressed?"));
        messages.put(2, list);

        list = new ArrayList<Message>();
        list.add(new Message("What's the kitchen color?", "Have you decided?"));
        list.add(new Message("Oppression", "Have you seen how much AOC has been oppressed?"));
        messages.put(3, list);

        list = new ArrayList<Message>();
        list.add(new Message("What's the car color?", "Have you decided?"));
        list.add(new Message("Oppression", "Have you seen how much I has been oppressed?"));
        messages.put(4, list);
